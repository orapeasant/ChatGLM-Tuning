...
#VOL_MOUNT_PATH = Path("/home/ubuntu/courses/LLM_LuJin/llm_training/ChatGLM-Tuning")
VOL_MOUNT_PATH = Path("/home/ubuntu/courses")
#BASE_MODEL = str(VOL_MOUNT_PATH / "chatglm2")  

BASE_MODEL = "THUDM/chatglm2-6b"

#/LLM_LuJin/llm_training/ChatGLM-Tuning
...
app = modal.App(name="my fine tuning", image=image)
...
def finetune(num_train_epochs: int = 1, size_percentage: int = 10):
    ...
    def main():
        ...
        dataset_path=str(VOL_MOUNT_PATH / "data/wenlv_token")
        # init model
        model = AutoModel.from_pretrained(
            model_name, load_in_8bit=False, trust_remote_code=True, device_map="auto"
        )
